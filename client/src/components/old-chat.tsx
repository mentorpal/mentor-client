<<<<<<< HEAD:client/src/components/old-chat.tsx
/*
...
function OldChat(props: { height: number }): JSX.Element {
...
export default Chat;
>>>>>>> (incomplete): Video mentor answer can display a link that opens a webpage tab:client/src/components/chat.tsx
