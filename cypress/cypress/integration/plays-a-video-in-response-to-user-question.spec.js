...
describe("plays a video in response to a user question", () => {
    ...
    it("plays a mentor response and displays subtitles", () => {
        ...
        cy.get("#video-container video track")
            .should("have.attr", "src")
            .and("match", /.*clintanderson_A141_3_1.vtt$/);
    });
});